...
def plot_kmeans_algorithm():
    ...
    with mpl.rc_context(
        rc={"axes.prop_cycle": cycler("color", ["#0000aa", "#ff2020", "#50ff50"])}
    ):
        fig, axes = plt.subplots(
            3, 3, figsize=(10, 8), subplot_kw={"xticks": (), "yticks": ()}
        )
        axes = axes.ravel()
